...
public class AbSlidingPlayView extends LinearLayout
{
	...
	/** 导航的布局. */
	public LinearLayout navLinearLayout;
	...
	/** 状态. */
	private AbOnPageScrollStateChangedListener mAbOnPageScrollStateChangedListener;
	...
	/** 导航点是否可见. */
	private int indexVisible=View.VISIBLE;
	/**
...
//		mViewPager.setId(1985);
		...
		displayImage = BitmapFactory.decodeResource(getResources(), R.drawable.spot_green);
		hideImage = BitmapFactory.decodeResource(getResources(), R.drawable.spot_pray);
		...
		mViewPager.setOnPageChangeListener(new OnPageChangeListener()
		{
			...
			{
				if (mAbOnPageScrollStateChangedListener != null)
				{
					mAbOnPageScrollStateChangedListener.onPageScrollStateChanged(state);
				}
			}
	...
	public void creatIndex()
	{
		...
		for (int j = 0; j < count; j++)
		{
			...
			imageView.setVisibility(indexVisible);
			navLinearLayout.addView(imageView, j);
		}
	}
	public void setIndexVisibilyty(int visible){
	...
	{
		if (mListViews != null && mListViews.size() > 1)
		{
			if (handler != null)
			{
				play = true;
	 ...
	 * 滑动状态监听接口
	 */
	public void setOnPageScrollStateChangedListener(AbOnPageScrollStateChangedListener abOnPageScrollStateChangedListener)
	{
		mAbOnPageScrollStateChangedListener = abOnPageScrollStateChangedListener;
	}
	 ...
	 * 滑动状态监听接口
	 */
	public interface AbOnPageScrollStateChangedListener
	{
