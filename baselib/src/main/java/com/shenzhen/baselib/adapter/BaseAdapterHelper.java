package com.shenzhen.baselib.adapter;
...
public class BaseAdapterHelper {
    ...
    protected BaseAdapterHelper(Context context, ViewGroup parent, int layoutId,
                                int position, int loading, int emptyImage, int onfail) {
        this.context = context;
        this.position = position;
        this.views = new SparseArray<View>();
        initImageLoader();
...
//                .showImageOnLoading(onLoadingImage) // resource or
//                .showImageForEmptyUri(emptyUriImage) // resource or
//                .showImageOnFail(onFailImage) // resource or
...
//        ImageLoader.getInstance().init(config);
    ...
    public BaseAdapterHelper setListViewHeight(int listId) {
        ListView listView = retrieveView(listId);
